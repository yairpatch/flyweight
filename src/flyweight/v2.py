...
class _QwenRuntimeInfo(ctypes.Structure):
    _fields_ = [
        ...
        # KV occupancy vs reservation; see plans/paged-kv-cache.md phase 0.
        ("kv_slots", ctypes.c_uint64),
        ("kv_reserved_bytes", ctypes.c_uint64),
        ("kv_peak_live_bytes", ctypes.c_uint64),
        ("kv_peak_tokens", ctypes.c_uint64),
        ("kv_peak_tokens_max", ctypes.c_uint64),
        ("kv_occupancy_samples", ctypes.c_uint64),
...
def _library() -> ctypes.CDLL:
    ...
    if os.name == "nt":
        names = ("flyweight_v2.dll", "flyweight_v2.dylib", "flyweight_v2.so")
    elif sys.platform == "darwin":
        names = ("flyweight_v2.dylib", "flyweight_v2.so", "flyweight_v2.dll")
    else:
        names = ("flyweight_v2.so", "flyweight_v2.dylib", "flyweight_v2.dll")
    for name in names:
        path = root / name
        if path.is_file():
            lib = ctypes.CDLL(str(path))
            try:
                lib.flyweight_v2_last_error.restype = ctypes.c_char_p
                lib.flyweight_v2_version.argtypes = []
                lib.flyweight_v2_version.restype = ctypes.c_uint32
                lib.flyweight_v2_runtime_options_size.argtypes = []
                ...
                lib.flyweight_v2_model_config.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(_ModelConfig),
                ]
                lib.flyweight_v2_model_config.restype = ctypes.c_int
                lib.flyweight_v2_model_chat_template.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                    ctypes.c_uint64,
                    ctypes.POINTER(ctypes.c_uint64),
                ]
                lib.flyweight_v2_model_chat_template.restype = ctypes.c_int
                lib.flyweight_v2_model_attach_mtp.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                ]
                ...
                lib.flyweight_v2_hf_quant_options.restype = ctypes.c_int
                lib.flyweight_v2_model_attention_window.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint32,
                    ctypes.POINTER(ctypes.c_uint32),
                ]
                lib.flyweight_v2_model_attention_window.restype = ctypes.c_int
                lib.flyweight_v2_model_compress_ratios.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_int32,
                ]
                lib.flyweight_v2_model_compress_ratios.restype = ctypes.c_int
                lib.flyweight_v2_model_target_layers.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_int32,
                ]
                lib.flyweight_v2_model_target_layers.restype = ctypes.c_int
                lib.flyweight_v2_dspark_encode.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                    ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_encode.restype = ctypes.c_int
                lib.flyweight_v2_dspark_runtime_create.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_void_p),
                ]
                lib.flyweight_v2_dspark_runtime_create.restype = ctypes.c_int
                lib.flyweight_v2_dspark_runtime_free.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_dspark_runtime_reset.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_dspark_runtime_reset.restype = ctypes.c_int
                lib.flyweight_v2_dspark_inject.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_inject.restype = ctypes.c_int
                lib.flyweight_v2_dspark_cached.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.c_uint32,
                    ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_cached.restype = ctypes.c_int
                lib.flyweight_v2_dspark_heads.argtypes = [
                    ctypes.c_void_p,
                ...
                lib.flyweight_v2_dspark_heads.restype = ctypes.c_int
                lib.flyweight_v2_dspark_attention.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32,
                    ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float),
                    ctypes.c_uint32, ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_attention.restype = ctypes.c_int
                lib.flyweight_v2_dspark_attention_stage.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_float),
                    ctypes.c_uint32, ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_attention_stage.restype = ctypes.c_int
                lib.flyweight_v2_dspark_ffn_stage.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_float),
                    ctypes.c_uint32, ctypes.POINTER(ctypes.c_float), ctypes.c_uint64,
                ]
                lib.flyweight_v2_dspark_ffn_stage.restype = ctypes.c_int
                lib.flyweight_v2_dspark_decode_hidden.argtypes = [
                ...
                lib.flyweight_v2_dspark_decode_hidden.restype = ctypes.c_int
                lib.flyweight_v2_pretokenize.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                    ctypes.POINTER(ctypes.c_uint64),
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_pretokenize.restype = ctypes.c_int
                lib.flyweight_v2_quant_supported.argtypes = [ctypes.c_uint32]
                lib.flyweight_v2_quant_supported.restype = ctypes.c_int
                _float_p = ctypes.POINTER(ctypes.c_float)
                lib.flyweight_v2_deepseek4_hyper_connection.argtypes = [
                ...
                lib.flyweight_v2_deepseek4_hyper_connection.restype = ctypes.c_int
                lib.flyweight_v2_matvec.argtypes = [
                    ctypes.c_void_p, ctypes.c_char_p, _float_p,
                    ctypes.c_int32, _float_p, ctypes.c_int32,
                ]
                lib.flyweight_v2_matvec.restype = ctypes.c_int
                lib.flyweight_v2_grouped_matvec.argtypes = [
                    ctypes.c_void_p, ctypes.c_char_p, _float_p,
                    ctypes.c_int32, _float_p, ctypes.c_int32, ctypes.c_int32,
                ]
                lib.flyweight_v2_grouped_matvec.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_attention.argtypes = [
                    _float_p, _float_p, _float_p, ctypes.POINTER(ctypes.c_uint8),
                    ctypes.c_int32, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_float, _float_p,
                ]
                lib.flyweight_v2_deepseek4_attention.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_rope.argtypes = [
                ...
                lib.flyweight_v2_deepseek4_rope.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_head.argtypes = [
                    _float_p, _float_p, _float_p, _float_p,
                    ctypes.c_int32, ctypes.c_int32, ctypes.c_float, ctypes.c_float,
                    _float_p, _float_p,
                ]
                lib.flyweight_v2_deepseek4_head.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_runtime_create.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_void_p),
                ]
                ...
                lib.flyweight_v2_deepseek4_runtime_reset.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_forward.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, _float_p,
                ]
                lib.flyweight_v2_deepseek4_forward.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_capture_layers.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint32,
                ]
                lib.flyweight_v2_deepseek4_capture_layers.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_captured.argtypes = [
                    ctypes.c_void_p, _float_p, ctypes.c_uint64,
                ]
                lib.flyweight_v2_deepseek4_captured.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_lm_head.argtypes = [
                    ctypes.c_void_p, _float_p, ctypes.c_uint32,
                    _float_p, ctypes.c_uint64,
                ]
                lib.flyweight_v2_deepseek4_lm_head.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_prefill.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint32,
                ]
                lib.flyweight_v2_deepseek4_prefill.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_forward_batch.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint32,
                    _float_p, ctypes.c_uint64,
                ]
                lib.flyweight_v2_deepseek4_forward_batch.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_forward_batch_capture.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint32,
                    _float_p, ctypes.c_uint64, _float_p, ctypes.c_uint64,
                ]
                lib.flyweight_v2_deepseek4_forward_batch_capture.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_snapshot.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
                lib.flyweight_v2_deepseek4_snapshot.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_restore.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
                lib.flyweight_v2_deepseek4_restore.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_snapshot_free.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_deepseek4_runtime_info.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(_Deepseek4Info),
                ]
                lib.flyweight_v2_deepseek4_runtime_info.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_half_round_trip.argtypes = [ctypes.c_float]
                lib.flyweight_v2_deepseek4_half_round_trip.restype = ctypes.c_float
                lib.flyweight_v2_deepseek4_gather_block.argtypes = [
                    _float_p, _float_p, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_int32, ctypes.c_int32, ctypes.c_int32,
                    _float_p, _float_p, ctypes.POINTER(ctypes.c_int32),
                ]
                lib.flyweight_v2_deepseek4_gather_block.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_visible_keys.argtypes = [
                    ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_int32, ctypes.POINTER(ctypes.c_uint8),
                    ctypes.POINTER(ctypes.c_int32),
                ]
                lib.flyweight_v2_deepseek4_visible_keys.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_runtime_gpu_attach.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_deepseek4_runtime_gpu_attach.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_runtime_gpu.argtypes = [
                    ctypes.c_void_p, ctypes.c_int32,
                ]
                lib.flyweight_v2_deepseek4_runtime_gpu.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_runtime_gpu_share.argtypes = [
                    ctypes.c_void_p, ctypes.c_void_p,
                ]
                lib.flyweight_v2_deepseek4_runtime_gpu_share.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_gpu_matvec_check.argtypes = [
                ...
                lib.flyweight_v2_deepseek4_gpu_matvec_check.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_indexer_key.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.c_uint32,
                    _float_p, ctypes.c_int32,
                ]
                lib.flyweight_v2_deepseek4_indexer_key.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_indexer_scores.argtypes = [
                    _float_p, _float_p, _float_p, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_int32, _float_p,
                ]
                lib.flyweight_v2_deepseek4_indexer_scores.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_top_k.argtypes = [
                    _float_p, ctypes.c_int32, ctypes.c_int32,
                    ctypes.POINTER(ctypes.c_uint8),
                ]
                lib.flyweight_v2_deepseek4_top_k.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_compress.argtypes = [
                    _float_p, _float_p, ctypes.c_int32, ctypes.c_int32, _float_p,
                ]
                lib.flyweight_v2_deepseek4_compress.restype = ctypes.c_int
                lib.flyweight_v2_expert_matvec.argtypes = [
                    ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int32, _float_p,
                    ctypes.c_int32, _float_p, ctypes.c_int32,
                ]
                lib.flyweight_v2_expert_matvec.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_router.argtypes = [
                    _float_p, _float_p, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_float, ctypes.c_float, ctypes.c_int32,
                    ctypes.POINTER(ctypes.c_int32), _float_p,
                ]
                lib.flyweight_v2_deepseek4_router.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_swiglu.argtypes = [
                    _float_p, _float_p, ctypes.c_int32, ctypes.c_float, _float_p,
                ]
                lib.flyweight_v2_deepseek4_swiglu.restype = ctypes.c_int
                lib.flyweight_v2_deepseek4_rms_norm.argtypes = [
                    _float_p, _float_p, ctypes.c_int32, ctypes.c_int32,
                    ctypes.c_float, _float_p,
                ]
                lib.flyweight_v2_deepseek4_rms_norm.restype = ctypes.c_int
                lib.flyweight_v2_qwen_validate.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_qwen_validate.restype = ctypes.c_int
                lib.flyweight_v2_qwen_tensor_role.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                    ctypes.POINTER(_TensorInfo),
                ]
                lib.flyweight_v2_qwen_tensor_role.restype = ctypes.c_int
                lib.flyweight_v2_qwen_layer_tensor.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint32,
                    ctypes.c_char_p,
                    ctypes.POINTER(_TensorInfo),
                ]
                lib.flyweight_v2_qwen_layer_tensor.restype = ctypes.c_int
                lib.flyweight_v2_qwen_embedding.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint32,
                    ctypes.POINTER(ctypes.c_float),
                    ctypes.c_uint64,
                ]
                lib.flyweight_v2_qwen_embedding.restype = ctypes.c_int
                lib.flyweight_v2_qwen_lm_head.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_float),
                    ctypes.POINTER(ctypes.c_float),
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_qwen_lm_head.restype = ctypes.c_int
                lib.flyweight_v2_qwen_token_text.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint32,
                    ctypes.c_char_p,
                    ctypes.c_uint64,
                ]
                lib.flyweight_v2_qwen_token_text.restype = ctypes.c_int
                lib.flyweight_v2_token_id.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                    ctypes.POINTER(ctypes.c_uint32),
                ]
                lib.flyweight_v2_token_id.restype = ctypes.c_int
                lib.flyweight_v2_tokenize.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_char_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_tokenize.restype = ctypes.c_int
                lib.flyweight_v2_tensor_read.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint64,
                    ctypes.c_void_p,
                    ctypes.c_uint64,
                ]
                lib.flyweight_v2_tensor_read.restype = ctypes.c_int
                lib.flyweight_v2_tensor_read_slice.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_void_p,
                ...
                lib.flyweight_v2_tensor_read_slice.restype = ctypes.c_int
                lib.flyweight_v2_tensor_view.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_tensor_view.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_create.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(_QwenRuntimeOptions),
                    ctypes.POINTER(ctypes.c_void_p),
                ]
                lib.flyweight_v2_qwen_runtime_create.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_destroy.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_qwen_runtime_info.argtypes = [
                    ctypes.c_void_p,
                ...
                lib.flyweight_v2_qwen_runtime_cancel.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_dump_kv.argtypes = [
                    ctypes.c_void_p, ctypes.c_uint32, ctypes.c_char_p,
                ]
                lib.flyweight_v2_qwen_runtime_dump_kv.restype = ctypes.c_int
                lib.flyweight_v2_qwen_imatrix_count.argtypes = [
                    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64),
                ]
                lib.flyweight_v2_qwen_imatrix_count.restype = ctypes.c_int
                lib.flyweight_v2_qwen_imatrix_entry.argtypes = [
                ...
                lib.flyweight_v2_qwen_imatrix_entry.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_prepare.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_qwen_runtime_prepare.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_synchronize.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_qwen_runtime_synchronize.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_decode.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_uint32,
                    ctypes.POINTER(ctypes.c_uint32),
                ]
                lib.flyweight_v2_qwen_runtime_decode.restype = ctypes.c_int
                lib.flyweight_v2_qwen_runtime_generate.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_qwen_runtime_generate.restype = ctypes.c_int
                lib.flyweight_v2_qwen_task_submit.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_qwen_task_submit.restype = ctypes.c_int
                lib.flyweight_v2_qwen_task_submit_sampling.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_qwen_task_submit_sampling.restype = ctypes.c_int
                lib.flyweight_v2_qwen_task_submit_penalties.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_qwen_task_submit_penalties.restype = ctypes.c_int
                lib.flyweight_v2_qwen_task_submit_grammar.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_uint32),
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_probe.restype = ctypes.c_int
                lib.flyweight_v2_gpu_available.restype = ctypes.c_int
                lib.flyweight_backend_select.argtypes = [ctypes.c_int]
                lib.flyweight_backend_select.restype = ctypes.c_int
                lib.flyweight_backend_active.restype = ctypes.c_int
                lib.flyweight_v2_gpu_init.argtypes = [ctypes.c_int32]
                lib.flyweight_v2_gpu_init.restype = ctypes.c_int
                lib.flyweight_v2_gpu_compile.argtypes = [
                    ctypes.c_char_p,
                ...
                lib.flyweight_v2_gpu_compile.restype = ctypes.c_int
                lib.flyweight_v2_memory_plan.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_memory_plan.restype = ctypes.c_int
                lib.flyweight_v2_gpu_rms_norm.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_int32,
                ...
                lib.flyweight_v2_gpu_rms_norm.restype = ctypes.c_int
                lib.flyweight_v2_gpu_q4_matvec.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_q4_matvec.restype = ctypes.c_int
                lib.flyweight_v2_gpu_dense_projection.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_dense_projection.restype = ctypes.c_int
                lib.flyweight_v2_gpu_dense_residual.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_dense_residual.restype = ctypes.c_int
                lib.flyweight_v2_gpu_attention.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_attention.restype = ctypes.c_int
                lib.flyweight_v2_gpu_decoder_attention_step.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                ...
                lib.flyweight_v2_gpu_decoder_attention_step.restype = ctypes.c_int
                lib.flyweight_v2_kv_cache_create.argtypes = [
                    ctypes.c_uint64,
                    ctypes.c_uint64,
                    ctypes.c_int32,
                    ctypes.c_int32,
                ...
                lib.flyweight_v2_kv_cache_create.restype = ctypes.c_int
                lib.flyweight_v2_kv_cache_destroy.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_kv_cache_reset.argtypes = [ctypes.c_void_p]
                lib.flyweight_v2_kv_cache_reset.restype = ctypes.c_int
                lib.flyweight_v2_kv_cache_position.argtypes = [
                    ctypes.c_void_p,
                    ctypes.POINTER(ctypes.c_int32),
                ]
                ...
                lib.flyweight_v2_gpu_decoder_attention_cached.restype = ctypes.c_int
                ...
                raise V2Error(
                    ...
                    "rebuild it with python -m flyweight.native_build"
                ) from error
            _cached_library = lib
            return lib
    # What to advise depends on whether there is a checkout to build from: an
    # installed copy has no `native/`, so the build command would fail on a
    # missing CMakeLists and send the reader in a circle.
    from .native_build import source_root

    if source_root() is not None:
        raise V2Error(
            f"the native runtime is not built ({root} holds no library). "
            "Build it with: python -m flyweight.native_build  "
            "(or reinstall with `pip install -e .`, which now builds it). "
            "Run `flyweight doctor` to check the toolchain first."
        )
    raise V2Error(
        f"the native runtime is missing from this install ({root} holds no "
        "library) and there are no sources beside it to build one from. "
        "Reinstall from a wheel that bundles the library, or from a clone."
    )
...
class BailingRuntime:
    ...
    opened with ``FLYWEIGHT_HF_QUANT=F32``.
    ...
    def __init__(self, model: "V2Model", capacity: int = 4096, slots: int = 1):
        ...
        self._lib.flyweight_v2_bailing_eval.argtypes = [
            ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.c_uint32,
            ctypes.POINTER(ctypes.c_float)
        ]
        self._lib.flyweight_v2_bailing_eval_slot.argtypes = [
            ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint32),
            ctypes.c_uint32, ctypes.POINTER(ctypes.c_float)
        ]
        self._lib.flyweight_v2_bailing_reset_slot.argtypes = [
            ctypes.c_void_p, ctypes.c_uint32
        ]
        self._check(
            self._lib.flyweight_v2_bailing_create_slots(
    ...
    def _query_slot_count(self) -> int:
        entry = self._lib.flyweight_v2_bailing_slot_count
    ...
    def _query_uses_gpu(self) -> bool:
        ...
        """
        try:
            entry = self._lib.flyweight_v2_bailing_uses_gpu
    ...
    def set_progress(self, callback: Any) -> None:
        ...
        """
        try:
            entry = self._lib.flyweight_v2_bailing_set_progress
        except AttributeError:
            self._progress = None
            return
    ...
    def _eval_into_buffer(self, tokens: Sequence[int], slot: int = 0) -> None:
        ...
        if slot == 0:
            self._check(
                self._lib.flyweight_v2_bailing_eval(
                    self._handle, buffer, ctypes.c_uint32(len(tokens)), self._logits
                )
            )
            return
        self._check(
            self._lib.flyweight_v2_bailing_eval_slot(
    ...
    def reset(self, slot: int = 0) -> None:
        if slot == 0:
            self._check(self._lib.flyweight_v2_bailing_reset(self._handle))
            return
        self._check(
            self._lib.flyweight_v2_bailing_reset_slot(
    ...
    def mtp_available(self) -> bool:
        ...
        entry = self._lib.flyweight_v2_bailing_mtp_available
        entry.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    ...
    def mtp_round(self, next_token: int, wanted: int = 4, slot: int = 0) -> list[int]:
        ...
        """
        entry = self._lib.flyweight_v2_bailing_mtp_round
        entry.argtypes = [
    ...
    def mtp_stats(self) -> dict[str, int]:
        ...
        entry = self._lib.flyweight_v2_bailing_mtp_stats
        entry.argtypes = [
            ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64),
    ...
    def save_state(self, slot: int = 0) -> bytes:
        ...
        """
        if slot == 0:
            save = self._lib.flyweight_v2_bailing_cache_save
            save.argtypes = [
            ...
            save = self._lib.flyweight_v2_bailing_cache_save_slot
            save.argtypes = [
    ...
    def close(self) -> None:
        if getattr(self, "_handle", None) and self._handle:
            self._lib.flyweight_v2_bailing_destroy(self._handle)
            self._handle = ctypes.c_void_p()
...
class V2Model:
    ...
    def hf_quant_options(path: str | Path) -> list[dict[str, object]]:
        ...
        count = ctypes.c_uint32()
        status = lib.flyweight_v2_hf_quant_options(
            str(path).encode(), buffer, len(buffer), ctypes.byref(count)
        )
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 error"
            raise V2Error(message.decode(errors="replace"))
        return [
            {
    ...
    def close(self) -> None:
        if self._handle:
            self._lib.flyweight_v2_model_close(self._handle)
            self._handle = ctypes.c_void_p()
    ...
    def info(self) -> dict[str, object]:
        value = _Info()
        self._check(self._lib.flyweight_v2_model_info(self._handle, ctypes.byref(value)))
        return {
    ...
    def tensors(self) -> Iterator[dict[str, object]]:
        ...
        for index in range(count):
            value = _TensorInfo()
            self._check(
                self._lib.flyweight_v2_tensor_info(
    ...
    def config(self) -> dict[str, int | float | str | tuple[bool, ...] | tuple[int, ...]]:
        value = _ModelConfig()
        self._check(
            self._lib.flyweight_v2_model_config(self._handle, ctypes.byref(value))
        )
        float_fields = {
            "rms_norm_epsilon",
            "rope_freq_base",
        ...
        for layer in range(value.layer_count):
            ...
            self._check(
                self._lib.flyweight_v2_model_attention_window(
    ...
    def target_layers(self) -> tuple[int, ...]:
        count = self._lib.flyweight_v2_model_target_layers(self._handle, None, 0)
        if count < 0:
            self._check(count)
        if not count:
            return ()
        buffer = (ctypes.c_uint32 * count)()
        written = self._lib.flyweight_v2_model_target_layers(
    ...
    def dspark_encode(self, features):
        ...
        self._check(self._lib.flyweight_v2_dspark_encode(
            self._handle,
    ...
    def unsupported_quant_types(self) -> dict[int, list[str]]:
        ...
        for tensor in self.tensors():
            ...
            if not self._lib.flyweight_v2_quant_supported(kind):
    ...
    def pretokenize(self, text: str) -> tuple[str, ...]:
        ...
        self._check(
            self._lib.flyweight_v2_pretokenize(
    ...
    def compress_ratios(self) -> tuple[int, ...]:
        ...
        """
        count = self._lib.flyweight_v2_model_compress_ratios(self._handle, None, 0)
        if count < 0:
            self._check(count)
        if count == 0:
            return ()
        buffer = (ctypes.c_uint32 * count)()
        written = self._lib.flyweight_v2_model_compress_ratios(self._handle, buffer, count)
        if written < 0:
            self._check(written)
    ...
    def chat_template(self) -> str | None:
        ...
        length = ctypes.c_uint64()
        self._check(
            self._lib.flyweight_v2_model_chat_template(
    ...
    def tensor(self, name: str) -> dict[str, object]:
        ...
        value = _TensorInfo()
        self._check(
            self._lib.flyweight_v2_tensor_find(
    ...
    def read_tensor(self, name: str) -> memoryview:
        ...
        self._check(
            self._lib.flyweight_v2_tensor_read(
    ...
    def read_tensor_slice(self, name: str, offset: int, size: int) -> memoryview:
        ...
        self._check(
            self._lib.flyweight_v2_tensor_read_slice(
    ...
    def view_tensor_slice(self, name: str, offset: int, size: int) -> memoryview:
        ...
        self._check(
            self._lib.flyweight_v2_tensor_view(
                self._handle,
                int(info["index"]),
                offset,
                size,
    ...
    def validate_qwen(self) -> None:
        self._check(self._lib.flyweight_v2_qwen_validate(self._handle))

    def qwen_tensor(self, role: str) -> dict[str, object]:
        value = _TensorInfo()
        self._check(
            self._lib.flyweight_v2_qwen_tensor_role(
    ...
    def qwen_layer_tensor(self, layer: int, role: str) -> dict[str, object]:
        value = _TensorInfo()
        self._check(
            self._lib.flyweight_v2_qwen_layer_tensor(
    ...
    def qwen_embedding(self, token: int, elements: int) -> list[float]:
        ...
        self._check(
            self._lib.flyweight_v2_qwen_embedding(self._handle, token, output, elements)
        )
        return list(output)
    ...
    def qwen_lm_head(self, hidden: list[float], vocabulary: int) -> list[float]:
        ...
        self._check(
            self._lib.flyweight_v2_qwen_lm_head(
    ...
    def token_text(self, token: int) -> str:
        ...
        while True:
            ...
            code = self._lib.flyweight_v2_qwen_token_text(
    ...
    def _tokenize_plain(self, text: str, capacity: int) -> list[int]:
        ...
        while True:
            ...
            count = ctypes.c_uint64()
            status = self._lib.flyweight_v2_tokenize(
                self._handle,
                encoded,
                tokens,
                capacity,
    ...
    def token_id(self, text: str) -> int:
        token = ctypes.c_uint32()
        self._check(
            self._lib.flyweight_v2_token_id(
    ...
    def active_backend() -> str:
        lib = _library()
        value = int(lib.flyweight_backend_active())
    ...
    def memory_plan(
        ...
        lib = _library()
        value = _MemoryPlan()
        status = lib.flyweight_v2_memory_plan(
            budget,
            static_weights,
            kv_state,
            workspace,
        ...
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 memory planner failed"
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_rms_norm(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_rms_norm(
            input_ptr, weights_ptr, output_ptr, size, epsilon, int(one_centered)
        )
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 RMSNorm failed"
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_prepare(
        ...
        status = lib.flyweight_v2_gpu_compile(
    ...
    def gpu_q4_matvec(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_q4_matvec(
            packed_ptr, scales_ptr, input_ptr, output_ptr, stream_ptr, rows, columns
        )
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 Q4 matvec failed"
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_dense_projection(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_dense_projection(
            input_ptr,
            norm_weights_ptr,
            normalized_ptr,
            packed_ptr,
        ...
        if status:
            message = (
                lib.flyweight_v2_last_error() or b"native v2 dense projection failed"
            )
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_dense_residual(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_dense_residual(
            input_ptr,
            norm_weights_ptr,
            normalized_ptr,
            packed_ptr,
        ...
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 dense residual failed"
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_attention(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_attention(
            query_ptr,
            keys_ptr,
            values_ptr,
            output_ptr,
        ...
        if status:
            message = lib.flyweight_v2_last_error() or b"native v2 attention failed"
            raise V2Error(message.decode(errors="replace"))
    ...
    def gpu_decoder_attention_step(
        ...
        lib = _library()
        status = lib.flyweight_v2_gpu_decoder_attention_step(
            input_ptr,
            norm_weights_ptr,
            normalized_ptr,
            qkv_packed_ptr,
...
class V2QwenRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        # cache. The native side refuses the combinations that would leave a
        # slot nothing could be routed to.
        if scratch_context < 0:
            raise ValueError("scratch_context must be non-negative")
    ...
    def close(self) -> None:
        if self._handle:
            self._lib.flyweight_v2_qwen_runtime_destroy(self._handle)
            self._handle = ctypes.c_void_p()
    ...
    def reset(self) -> None:
        self.model._check(self._lib.flyweight_v2_qwen_runtime_reset(self._handle))
    ...
    def dump_kv(self, layer: int, path: str) -> None:
        ...
        """
        self.model._check(
            self._lib.flyweight_v2_qwen_runtime_dump_kv(
    ...
    def imatrix_entries(self) -> list[tuple[str, list[float], int]]:
        ...
        FLYWEIGHT_IMATRIX=1 and has prefilled something since.
        """
        count = ctypes.c_uint64(0)
        self.model._check(
            self._lib.flyweight_v2_qwen_imatrix_count(
        ...
        for slot in range(count.value):
            ...
            self.model._check(
                self._lib.flyweight_v2_qwen_imatrix_entry(
    ...
    def decode(self, input_token: int) -> int:
        ...
        self.model._check(
            self._lib.flyweight_v2_qwen_runtime_decode(
    ...
    def generate(self, prompt_tokens: list[int], max_tokens: int, callback) -> None:
        ...
        self.model._check(
            self._lib.flyweight_v2_qwen_runtime_generate(
                self._handle,
                values,
                len(prompt_tokens),
                max_tokens,
    ...
    def engine_step(self, capacity: int = 256) -> list[tuple[int, int, int]]:
        ...
        count = ctypes.c_uint64()
        self.model._check(
            self._lib.flyweight_v2_qwen_engine_step(
...
class V2KvCache:
    def __init__(
        ...
        self._lib = _library()
        self._handle = ctypes.c_void_p()
        status = self._lib.flyweight_v2_kv_cache_create(
            cache_keys_ptr,
            cache_values_ptr,
            capacity,
            kv_heads,
        ...
        if status:
            message = (
                self._lib.flyweight_v2_last_error()
    ...
    def close(self) -> None:
        if self._handle:
            self._lib.flyweight_v2_kv_cache_destroy(self._handle)
            self._handle = ctypes.c_void_p()
    ...
    def position(self) -> int:
        ...
        status = self._lib.flyweight_v2_kv_cache_position(
    ...
    def reset(self) -> None:
        status = self._lib.flyweight_v2_kv_cache_reset(self._handle)
        if status:
    ...
    def decoder_attention_step(
        ...
        status = self._lib.flyweight_v2_gpu_decoder_attention_cached(
            self._handle,
            input_ptr,
            norm_weights_ptr,
            normalized_ptr,
