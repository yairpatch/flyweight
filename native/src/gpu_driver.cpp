...
extern "C" int flyweight_gpu_compile(
    ...
    for (const char* name : {
             ...
             // Diffusion tower (Z-Image DiT, Qwen3 encoder, KL decoder)
             "diff_add_bias_rows", "diff_scale_columns", "diff_gated_add_rows",
             "diff_silu_mul", "diff_silu_rows", "diff_modulation_prepare",
             ...
             "diff_interleave_qkv", "diff_swiglu_gate_up",
             ...
             "k2_half_split_rope", "k2_attention_gate",
             ...
             "iq3s_grouped_swiglu", "iq3s_grouped_swiglu_rows",
             "iq3s_grouped_accumulate", "iq3s_grouped_accumulate_rows",
             "iq3s_q8_mmq_routed",
             ...
             "iq2s_grouped_swiglu", "iq2s_grouped_swiglu_rows",
             ...
             "q4k_value_experts", "q4k_value_experts_rows",
             "q5k_value_experts", "q5k_value_experts_rows",
             "q6k_value_experts", "q6k_value_experts_rows",
             "q8_value_experts", "q8_value_experts_rows",
             ...
             "nvfp4_matmul_rows", "nvfp4_matmul_tiled",
             "nvfp4_matvec_transposed_warp",
             "qwen_nvfp4_embedding", "qwen_nvfp4_embedding_rows",
             "q8_matmul_tiled", "q8_matvec_transposed_pair",
             "q8_matvec_transposed_triple", "delta_conv_chunk",
             "qwen_delta_recurrent_chunk", "qwen_delta_recurrent_chunk_pre",
             "qwen_delta_scan_prologue",
             ...
             "kv_store_turbo3_k_rows", "kv_store_turbo3_v_rows", "kv_store_turbo4_k_rows", "kv_store_turbo4_v_rows",
             "kv_store_f32_rows", "kv_store_f16_rows", "kv_store_bf16_rows", "kv_store_q8_rows",
             "kv_store_hadamard_q8", "kv_store_hadamard_q8_rows",
             "kv_attention_scores_hadamard_q8", "kv_attention_scores_hadamard_q8_ring",
             "kv_attention_fused_hadamard_q8_tiles", "kv_attention_fused_hadamard_q8_tiles256",
             ...
             "turbo_rotate_rows", "turbo_unrotate_rows", "hadamard_rotate_rows",
             ...
             "kv_attention_gqa_mma_f16_128_s4_t256", "kv_attention_gqa_mma_f16_128_s4_t512",
             ...
             "kv_attention_scores_hadamard_q8_indexed",
